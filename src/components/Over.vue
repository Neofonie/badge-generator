<template>
  <div class="overvue">
    ...
    <span class="overvue__settings">
      DPI: <select v-model="dpi">
            <option>Bitte wählen</option>
            <option v-for="dpi in defaults.dpi">{{dpi}}</option>
          </select>
    </span>
          ...
          <div class="overvue__badge__wrap">
            ...
            <span class="overvue__badge__edit-bar">
              <i class="fas fa-pen-square"
                 ...
                 v-on:click="edit(key)"></i>
              <span
                class="overvue__badge__edit-bar__sub-bar"
                v-if="data.isEditMode">
                <i class="fas fa-search-minus"
                   v-if="data.size==='big'"
                   v-on:click="scale(key)"></i>
                <i class="fas fa-search-plus"
                   v-if="data.size==='small'"
                   v-on:click="scale(key)"></i>

                |

                <i class="fas fa-circle"
                   v-bind:class="{ active: data.iconStyle === 'circle' }"
                   v-on:click="iconStyle(key, 'circle')"></i>
                <i class="fas fa-sort-up"
                   v-bind:class="{ active: data.iconStyle === 'triangle' }"
                   v-on:click="iconStyle(key, 'triangle')"></i>
                <i class="fas fa-square"
                   v-bind:class="{ active: data.iconStyle === 'round' }"
                   v-on:click="iconStyle(key, 'round')"></i>
                <i class="fas fa-square-full"
                   v-bind:class="{ active: data.iconStyle === 'square' }"
                   v-on:click="iconStyle(key, 'square')"></i>
              </span>
            </span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      iconStyle(index, style) {
        this.badges[index].iconStyle = style;
      },
      edit(index) {
